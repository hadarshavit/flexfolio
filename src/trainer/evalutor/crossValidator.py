...
class CrossValidator(Validator):
    ...
    def evaluate(self, trainer, meta_info, instance_train_dic, config_dic, threads=1, ain_num_ft_to_remove = 0, aspeed_call=False):
        '''
        ...
        for iteration in range(0, self._n_folds):
            ...
            #TRAINING
            selection_dic, solver_schedule = self.training(instance_train, meta_info, config_dic, trainer, aspeed_call=aspeed_call)
